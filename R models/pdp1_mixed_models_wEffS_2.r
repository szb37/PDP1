...
#df_stats$p.value <- as.character(df_stats$p.value)
#df_stats$adj.p.value <- as.character(df_stats$adj.p.value)
...
write.csv(df_stats, file=paste(export_dir,'/tmp_pdp1_mixed_models_v1.csv', sep=''), row.names=FALSE)